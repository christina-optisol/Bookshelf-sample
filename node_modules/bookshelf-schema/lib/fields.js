 ...
 *
 */
var BooleanField, DateField, DateTimeField, EmailField, EncryptedString, EncryptedStringField, Field, FloatField, IntField, JSONField, NumberField, StringField, UUIDField,
...
StringField = (function(superClass) {
  ...
  StringField.prototype.validations = function() {
    ...
    result.unshift(this._withMessage('string'));
    return result;
  };
...
UUIDField = (function(superClass) {
  extend(UUIDField, superClass);

  function UUIDField(name, options) {
    if (!(this instanceof UUIDField)) {
      return new UUIDField(name, options);
    }
    UUIDField.__super__.constructor.call(this, name, options);
  }

  UUIDField.prototype.validations = function() {
    var result;
    result = UUIDField.__super__.validations.apply(this, arguments);
    result.push(this._withMessage('uuid'));
    return result;
  };
